...
public class UF_HWQUPC implements UF {
    ...
    public static void main(String[] args){
        int[] n = {10,50,100,200,500,1000,3000,5000,6000,9000,11000,15000,18000};
        ...
        for (int i=0;i<n.length;i++){
            ...
            UF_HWQUPC k = new UF_HWQUPC(n[i]);
            
            while(k.count != 1){
                m++;
                int m1 = rand.nextInt(n[i]);
                int m2= rand.nextInt(n[i]);
                if(!k.isConnected(m1,m2)){
                    k.union(m1,m2);
                }
            }
            }
            System.out.println(n[i]+" " + m/100);
